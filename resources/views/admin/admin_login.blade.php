...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{asset('backend_css/font-awesome/css/font-awesome.css') }}" rel="stylesheet" />
        ...
        <div id="loginbox"> 
            ...
            <form id="loginform" class="form-vertical" method="post" action="{{ url('admin') }}" >
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"> </i></span><input type="email" name="email" placeholder="Adresse mail" value="{{ old('email') }}" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right"><input type="submit" value="Connexion" class="btn btn-success" /></span>
                </div>
            </form>
